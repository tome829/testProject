...
public class book_infoDAO {
	private static final Logger logger = LoggerFactory.getLogger(book_infoDAO.class);
	...
	public RestResultVO book_infoSearch(ParameterVO paramVO) throws Exception {
		...
		searchVO.setFields(konanPropertiesService.getString("book_infoField"));
		searchVO.setFrom(konanPropertiesService.getString("book_infoFrom"));
		searchVO.setHilightTxt(konanPropertiesService.getString("book_infoHilight"));
		...
		logger.debug("RESTURL book_info : " + postParamData);
