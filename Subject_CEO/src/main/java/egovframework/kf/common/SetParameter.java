...
public class SetParameter {
	...
	/** EgovPropertyService ==> context-konanProperties */
	...
	public ParameterVO setParameter(@RequestParam Map<String, String> map) throws Exception{
		...
		//rtnParam.setPreviousQueries( getValues(map,"previousQuery") );	기존
		return rtnParam;
	}
	
	
	
	private String[] getValues(Map<String, String> map, String string) {
