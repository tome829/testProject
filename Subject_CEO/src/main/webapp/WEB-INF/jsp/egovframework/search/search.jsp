					...
					<div class="row">	
						<div id="contents" class="col-md-9 contents">	
							<c:choose>	
								...
								<c:when test="${params.category eq 'BOARD'} ">									
									<jsp:include page="result/resultBoard.jsp"/>	
								</c:when>
								<c:when test="${params.category eq 'PERSON'}">									
									<jsp:include page="result/resultPerson.jsp"/>	
								</c:when>
								<c:when test="${params.category eq 'NEWS' }">
									<jsp:include page="result/resultNews.jsp"/>
								</c:when>
								<c:when test="${params.category eq 'top_news' }">
									<jsp:include page="result/resultTop_news.jsp"/>
								</c:when>
								<c:when test="${params.category eq 'book_info' }">
									<jsp:include page="result/resultBook_info.jsp"/>
								</c:when>
								<c:otherwise>	
									<%-- <jsp:include page="result/resultPerson.jsp"/>	
									<jsp:include page="result/resultBoard.jsp"/>
