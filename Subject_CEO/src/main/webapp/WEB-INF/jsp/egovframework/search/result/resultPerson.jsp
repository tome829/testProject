...
<section>
    ...
    <li class="media">
      <div class="media-body">
        ...
        <span><c:out value="${result.prs_nm_en}"  escapeXml="false"/><c:out value="${result.dept_nm}"  escapeXml="false"/><c:out value="${result.fullpath}"/> | <c:out value="${result.phone_no }"/> | <c:out value="${result.mobile_no }"/></span>
        <p><c:out value="${result.email}"  escapeXml="false"/></p>
